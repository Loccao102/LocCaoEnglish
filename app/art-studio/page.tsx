...
export default function ArtStudioPage() {
  return <div className="page-wrap art-studio">
    ...
    <section className="model-collection" aria-labelledby="model-title">
      <div className="model-intro"><div><p className="eyebrow">FROM OUR LITTLE WORLD</p><h2 id="model-title">A world you can walk around.</h2><p>Twenty-four chibi companions, seven places to discover, little objects and a complete island. These are the models used to build the 3D adventure.</p></div><Link className="button primary" href="/characters">Meet all 24 friends →</Link></div>
