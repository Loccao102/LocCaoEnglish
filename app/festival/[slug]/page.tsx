...
export default async function Page({params}:{params:Promise<{slug:string}>}){const {slug}=await params;const game=festivalById(slug);if(!game)notFound();return <FestivalGame game={game}/>;}
